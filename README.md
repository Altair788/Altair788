...
> 📌 **Backend-разработчик с 3+ летним опытом в создании серверных решений, REST API и микросервисов на Python (2 года из 3 - коммерческий опыт). Специализируюсь на Django, DRF, FastAPI, асинхронном Python (aiohttp), интеграциях с брокерами очередей и CI/CD, а также управлении проектами по созданию сайтов для интернет-магазинов. Автор open source-пакета для автоматизации тестирования DRF API.**

> 🏆 **1 место из 1379 участников** отборочного интенсива в соревнованиях трайбов. Повышаю экспертность в School21 (направление — backend, языки C, Golang).  
> 🥉 **4 место в Хакатоне Glowbyte AUTUMN 2025.**
...
## 🚀 Коммерческие проекты (более 20 реализованных решений)
