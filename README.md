...
> 🏆 **1 место из 1379 участников** отборочного интенсива в соревнованиях трайбов. Повышаю экспертность в School21 (направление — backend, языки C, Golang (на 2026 год)).  
...
### **ИИ-агент для персонального сопровождения**  

Спроектировал и реализовал многофункционального ИИ-агента на базе n8n и LLM, который:
- Автоматизирует выбор специализации в IT-образовании на основе анализа профиля пользователя.
- Генерирует персонализированные дайджесты новостей и вакансий.
- Создает учебные планы и отправляет обучающие посты по запросу пользователя.
- Реализован метод RAG для анализа резюме и подбора вакансий.
