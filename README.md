...
> 📌 **Backend-разработчик с 2+ летним коммерческим опытом в создании серверных решений, REST API и микросервисов на Python. Специализируюсь на Django, DRF, FastAPI, асинхронном Python (aiohttp), интеграциях с брокерами очередей и CI/CD, а также управлении проектами по созданию сайтов для интернет-магазинов. Автор open source-пакета для автоматизации тестирования DRF API.**
